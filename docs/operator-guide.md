...
2. Register the client's intake: business type, target public function,
   prior filing history in Australia if any.
3. Run the advisor in read-only mode against AusTender, the Australian Government's procurement information system.
...
- named referral relationship with Australian-licensed counsel or a
...
a working referral relationship with Australian-licensed counsel or a
registered agent for whatever licensed representation the law of
Australia requires for actual public-procurement filings.
