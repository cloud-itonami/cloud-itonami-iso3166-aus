# cloud-itonami-iso3166-aus

Open ISO 3166 Blueprint for **AUS**: Australia.
...
tax registration, and local-content rules in Australia, so the operator
...
- **Not the government of Australia.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Australian-licensed counsel
...
(ISO 3166 `AUS`). Required capabilities:
